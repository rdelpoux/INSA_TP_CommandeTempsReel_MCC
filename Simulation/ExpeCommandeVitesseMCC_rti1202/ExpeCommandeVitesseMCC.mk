...
#
#  $RCSfile: ExpeCommandeVitesseMCC.mk $ $Revision: 1.29 $ $Date: 2016/11/11 17:26:50CET $
...
MAKEFILE                       = ExpeCommandeVitesseMCC.mk
...
MATLAB_ROOT_ALT                = C:\MATLAB\R2017a
MATLAB_BIN_ALT                 = C:\MATLAB\R2017a\bin
RELEASE_VERSION                = R2017a
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN64
MODEL                          = ExpeCommandeVitesseMCC
MODULES                        = ExpeCommandeVitesseMCC_data.c ExpeCommandeVitesseMCC_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 2
...
RTWCUST_INCLUDES = \
    ...
    "$(START_DIR)\ExpeCommandeVitesseMCC_rti1202" \
    "H:\Enseignement\Microchip\dSpace"
