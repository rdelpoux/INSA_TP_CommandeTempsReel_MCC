/************************ dSPACE target specific file *************************
   ...
   Include file .\ExpeCommandeVitesseMCC_rti1202\ExpeCommandeVitesseMCC_th.c :

   Task Configuration file for model : ExpeCommandeVitesseMCC

   RTI1202 7.8 (02-May-2017)/2.17
   21-Sep-2018 10:40:33
...
/* ===== List of model tasks and assigned interrupt sources ================
   ...
   DIO_CLASS1_HWINT_BL1           : EMC MCPWM Port 3 Channel 1 Start position
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\ExpeCommandeVitesseMCC_rti1202\ExpeCommandeVitesseMCC_th.c is for ST).
# endif
...
int                  *pRti_TIMERA_Prio;
  ...
  /* --- Task  2 : DIO_CLASS1_HWINT_BL1 (HWINT 120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1) */
double               *pRti_120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1_TTime;
rtk_task_state_type  *pRti_120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1_TState;
rtk_ovc_check_type   *pRti_120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1_OType;
int                  *pRti_120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1_OMax;
int                  *pRti_120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1_ORpt;
int                  *pRti_120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1_OCnt;
double               *pRti_120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1_TCnt;
int                  *pRti_120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1_Prio;
...
# endif
   ...
   * Source IntNo: PWM_CA_BEGIN_OF_PERIOD, SubIntNo: RTK_NO_SINT, TaskId: -1
   * ----------------------------------------------------------------------- */
  service   = S_RTLIB_FPGA_IO;                     /*  RTK service.                     */
  subentry = rtk_get_subentry( /* --- Get RTK subentry. ----------- */
      service,                 /*  RTK service.                     */
      IOLIB_SPEC_INT_DIO_CL1_PWM_CA(33),                 /*  Board base address.              */
      PWM_CA_BEGIN_OF_PERIOD);                /*  Interrupt number.                */
  pTask2   = rtith_create_task( /* --- Create task. ---------------- */
      rti_120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1,                 /*  Task function pointer.           */
      2,                 /*  Task priority.                   */
      ovc_fcn,                 /*  RTK overrun check type.          */
      rti_default_overrun_fcn,                 /*  Overrun handler function.        */
      1,                 /*  Overrun count limit.             */
  ...
  /* ... Assign task information variables ................................. */
  pRti_120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1_TTime = &(pTask2->turnaround_time);
  pRti_120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1_TState = &(pTask2->state);
  pRti_120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1_OType = &(pTask2->ovc_type);
  pRti_120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1_OMax = &(pTask2->ovc_max);
  pRti_120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1_ORpt = &(pTask2->ovc_repeat);
  pRti_120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1_OCnt = &(pTask2->ovc_counter);
  pRti_120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1_TCnt = &(pTask2->tm_task_calls);
  pRti_120XDIOCL1MCPWM_BEGIN_OF_PERIODP3Ch1_Prio = &(pTask2->priority);
